"""
Django settings for dekoflix project.
...
TOKEN_CSRF = '223eb7a16f6e7afa07712435958a1e60ee75388bd91844e7'
if TOKEN_CSRF:
...
WSGI_APPLICATION = 'dekoflix.wsgi.application'
...
#Construir meu proprio usuario, declaramos aqui pra dizer que nao é mais a padrao, é a tabela que construimos
#filme = é o nome do app que criamos, nao de classe,DB,etc
#Usuario = nome da classe que criamos dentro do app filme.models
...
#Aonde minhas imagens vao ser armazenadas - devo criar a pasta static manualmente
#dentro do meu projeto principal
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
...
#Esse é o sucess url do LoginView
