    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('FICCAO_CIENTIFICA', 'Ficção Científica'), ('FANTASIA', 'Fantasia'), ('AVENTURA', 'Aventura'), ('THRILLER', 'Thriller'), ('OUTROS', 'Outros')], max_length=20)),
